...
var config = {
  mapsApiKey: "AIzaSyDledkfRPKVQchOfwzE9pSMK5yypjRh3bs",
  firebaseApiKey: "AIzaSyDpphkFacb-a_vtf0WGEQHkiKcJh2jJVfg",
  firebaseDatabaseURL: "https://asdf123-1537543048053.firebaseio.com"
};
...
database.ref("raw-locations").on("value", function(data) {
  ...
  if (!transports) {
    ...
    html = ejs.render($("#transports-template").html(), {
